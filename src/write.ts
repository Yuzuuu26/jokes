...
export function addCSV(arrayLengthString: string, jokeHolder: string, punchlineHolder: string, filePath: string): string {
...
export function addJSON(arrayLengthString: string, jokeHolder: string, punchlineHolder: string, filePath: string): RowData {
  let jsonObjects: RowData[] = JSON.parse(fs.readFileSync(filePath, 'utf-8'));
