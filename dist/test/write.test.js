...
describe('write.addJSON', () => {
    it('Checks if joke is added to JSON file', () => {
        const sentence = addJSON('1', 'Why did the chicken cross the road?', 'To get to the other side!', JsonfilePath);
...
describe('write.addCSV', () => {
    it('Checks if joke is added to CSV file', () => {
        const sentence = addCSV('1', 'Why did the chicken cross the road?', 'To get to the other side!', CSVfilePath);
